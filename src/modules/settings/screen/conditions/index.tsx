  ...
  return (
    <ActivityPenal title="Điều khoản khi mua hàng">
      <View style={[styleGlobal.marginTop_4, styleGlobal.padding_10, styles.container]}>
        <Text style={[styleGlobal.textPrimary]}>Bấm vô làm cái mọe gì không biết. Ngứa tay à.</Text>
        <Text style={[styleGlobal.textPrimary]}>Chịu không nghĩ thêm được gì nữa rồi.</Text>
      </View>
    </ActivityPenal>
  );
};
